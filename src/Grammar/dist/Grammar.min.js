...
(a=e.substr(b,6),b+=6):(a=null,0===f&&g('"opaque"'));null!==a?(c=v(),null!==c?(d=ka(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.opaque=a[2],a=void 0);null===a&&(b=h);return a}function Ec(){var a,c,d,h,j;j=h=b;"stale"===e.substr(b,5).toLowerCase()?(a=e.substr(b,5),b+=5):(a=null,0===f&&g('"stale"'));null!==a?(c=v(),null!==c?("true"===e.substr(b,4).toLowerCase()?(d=e.substr(b,4),b+=4):(d=null,0===f&&g('"true"')),null===d&&("false"===e.substr(b,5).toLowerCase()?(d=e.substr(b,
5),b+=5):(d=null,0===f&&g('"false"'))),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.stale=/^true/i.test(a[2])?!0:!1,a=void 0);null===a&&(b=h);return a}function Fc(){var a,c,d,h,j;j=h=b;"algorithm"===e.substr(b,9).toLowerCase()?(a=e.substr(b,9),b+=9):(a=null,0===f&&g('"algorithm"'));null!==a?(c=v(),null!==c?("md5"===e.substr(b,3).toLowerCase()?(d=e.substr(b,3),b+=3):(d=null,0===f&&g('"MD5"')),null===d&&("md5-sess"===e.substr(b,8).toLowerCase()?(d=e.substr(b,8),b+=8):(d=
null,0===f&&g('"MD5-sess"')),null===d&&(d=t())),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.algorithm=a[2].toUpperCase(),a=void 0);null===a&&(b=h);return a}function Gc(){var a,c,d,h,j,l,k,q,p,r;q=b;"qop"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"qop"'));if(null!==a)if(c=v(),null!==c)if(d=Ma(),null!==d){p=b;h=za();if(null!==h){j=[];r=b;44===e.charCodeAt(b)?(l=",",b++):(l=null,0===f&&g('","'));null!==l?(k=za(),null!==k?l=[l,k]:(l=null,b=r)):
(l=null,b=r);for(;null!==l;)j.push(l),r=b,44===e.charCodeAt(b)?(l=",",b++):(l=null,0===f&&g('","')),null!==l?(k=za(),null!==k?l=[l,k]:(l=null,b=r)):(l=null,b=r);null!==j?h=[h,j]:(h=null,b=p)}else h=null,b=p;null!==h?(j=Na(),null!==j?a=[a,c,d,h,j]:(a=null,b=q)):(a=null,b=q)}else a=null,b=q;else a=null,b=q;else a=null,b=q;return a}function za(){var a,c;c=b;"auth-int"===e.substr(b,8).toLowerCase()?(a=e.substr(b,8),b+=8):(a=null,0===f&&g('"auth-int"'));null===a&&("auth"===e.substr(b,4).toLowerCase()?
(a=e.substr(b,4),b+=4):(a=null,0===f&&g('"auth"')),null===a&&(a=t()));null!==a&&(k.qop||(k.qop=[]),k.qop.push(a.toLowerCase()),a=void 0);null===a&&(b=c);return a}function Aa(){var a,c,d,h,e,f,g;f=e=b;a=O();if(null!==a){c=[];g=b;d=x();null!==d?(h=C(),null!==h?d=[d,h]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=x(),null!==d?(h=C(),null!==h?d=[d,h]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;if(null!==a){var q;k.multi_header||(k.multi_header=[]);try{q=new JsSIP.NameAddrHeader(k.uri,
k.display_name,k.params),delete k.uri,delete k.display_name,delete k.params}catch(p){q=null}k.multi_header.push({possition:b,offset:e,parsed:q});a=void 0}null===a&&(b=e);return a}function Ba(){var a,c,d,h,e,f;e=b;a=O();if(null!==a){c=[];f=b;d=x();null!==d?(h=C(),null!==h?d=[d,h]:(d=null,b=f)):(d=null,b=f);for(;null!==d;)c.push(d),f=b,d=x(),null!==d?(h=C(),null!==h?d=[d,h]:(d=null,b=f)):(d=null,b=f);null!==c?a=[a,c]:(a=null,b=e)}else a=null,b=e;return a}function Jc(){var a,c;c=b;"active"===e.substr(b,
6).toLowerCase()?(a=e.substr(b,6),b+=6):(a=null,0===f&&g('"active"'));null===a&&("pending"===e.substr(b,7).toLowerCase()?(a=e.substr(b,7),b+=7):(a=null,0===f&&g('"pending"')),null===a&&("terminated"===e.substr(b,10).toLowerCase()?(a=e.substr(b,10),b+=10):(a=null,0===f&&g('"terminated"')),null===a&&(a=t())));null!==a&&(k.state=e.substring(b,c),a=void 0);null===a&&(b=c);return a}function gb(){var a,c,d,h,j;j=h=b;"reason"===e.substr(b,6).toLowerCase()?(a=e.substr(b,6),b+=6):(a=null,0===f&&g('"reason"'));
null!==a?(c=v(),null!==c?(d=Kc(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(a=a[2],"undefined"!==typeof a&&(k.reason=a),a=void 0);null===a&&(b=h);null===a&&(j=h=b,"expires"===e.substr(b,7).toLowerCase()?(a=e.substr(b,7),b+=7):(a=null,0===f&&g('"expires"')),null!==a?(c=v(),null!==c?(d=P(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j),null!==a&&(a=a[2],"undefined"!==typeof a&&(k.expires=a),a=void 0),null===a&&(b=h),null===a&&(j=h=b,"retry_after"===e.substr(b,
11).toLowerCase()?(a=e.substr(b,11),b+=11):(a=null,0===f&&g('"retry_after"')),null!==a?(c=v(),null!==c?(d=P(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j),null!==a&&(a=a[2],"undefined"!==typeof a&&(k.retry_after=a),a=void 0),null===a&&(b=h),null===a&&(a=C())));return a}function Kc(){var a;"deactivated"===e.substr(b,11).toLowerCase()?(a=e.substr(b,11),b+=11):(a=null,0===f&&g('"deactivated"'));null===a&&("probation"===e.substr(b,9).toLowerCase()?(a=e.substr(b,9),b+=9):(a=null,0===f&&
g('"probation"')),null===a&&("rejected"===e.substr(b,8).toLowerCase()?(a=e.substr(b,8),b+=8):(a=null,0===f&&g('"rejected"')),null===a&&("timeout"===e.substr(b,7).toLowerCase()?(a=e.substr(b,7),b+=7):(a=null,0===f&&g('"timeout"')),null===a&&("giveup"===e.substr(b,6).toLowerCase()?(a=e.substr(b,6),b+=6):(a=null,0===f&&g('"giveup"')),null===a&&("noresource"===e.substr(b,10).toLowerCase()?(a=e.substr(b,10),b+=10):(a=null,0===f&&g('"noresource"')),null===a&&("invariant"===e.substr(b,9).toLowerCase()?(a=
e.substr(b,9),b+=9):(a=null,0===f&&g('"invariant"')),null===a&&(a=t())))))));return a}function hb(){var a;a=eb();null===a&&(a=C());return a}function Ca(){var a,c,d,h,e,f,g,k;g=b;a=Lc();if(null!==a)if(c=A(),null!==c)if(d=Mc(),null!==d){h=[];k=b;e=x();null!==e?(f=ib(),null!==f?e=[e,f]:(e=null,b=k)):(e=null,b=k);for(;null!==e;)h.push(e),k=b,e=x(),null!==e?(f=ib(),null!==f?e=[e,f]:(e=null,b=k)):(e=null,b=k);null!==h?a=[a,c,d,h]:(a=null,b=g)}else a=null,b=g;else a=null,b=g;else a=null,b=g;return a}function ib(){var a;
a=Nc();null===a&&(a=Oc(),null===a&&(a=Pc(),null===a&&(a=Qc(),null===a&&(a=Rc(),null===a&&(a=C())))));return a}function Nc(){var a,c,d,h,j;j=h=b;"ttl"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"ttl"'));null!==a?(c=v(),null!==c?(d=Xa(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.ttl=a[2],a=void 0);null===a&&(b=h);return a}function Oc(){var a,c,d,h,j;j=h=b;"maddr"===e.substr(b,5).toLowerCase()?(a=e.substr(b,5),b+=5):(a=null,0===f&&g('"maddr"'));
null!==a?(c=v(),null!==c?(d=W(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.maddr=a[2],a=void 0);null===a&&(b=h);return a}function Pc(){var a,c,d,h,j;j=h=b;"received"===e.substr(b,8).toLowerCase()?(a=e.substr(b,8),b+=8):(a=null,0===f&&g('"received"'));null!==a?(c=v(),null!==c?(d=N(),null===d&&(d=Va()),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.received=a[2],a=void 0);null===a&&(b=h);return a}function Qc(){var a,c,d,h,j;j=h=b;"branch"===e.substr(b,
6).toLowerCase()?(a=e.substr(b,6),b+=6):(a=null,0===f&&g('"branch"'));null!==a?(c=v(),null!==c?(d=t(),null!==d?a=[a,c,d]:(a=null,b=j)):(a=null,b=j)):(a=null,b=j);null!==a&&(k.branch=a[2],a=void 0);null===a&&(b=h);return a}function Rc(){var a,c,d,h,j,l,m;l=j=b;"rport"===e.substr(b,5).toLowerCase()?(a=e.substr(b,5),b+=5):(a=null,0===f&&g('"rport"'));if(null!==a){m=b;c=v();if(null!==c){d=[];for(h=s();null!==h;)d.push(h),h=s();null!==d?c=[c,d]:(c=null,b=m)}else c=null,b=m;c=null!==c?c:"";null!==c?a=[a,
c]:(a=null,b=l)}else a=null,b=l;null!==a&&("undefined"!==typeof response_port&&(k.rport=response_port.join("")),a=void 0);null===a&&(b=j);return a}function Lc(){var a,c,d,h,e,f;f=b;a=Sc();null!==a?(c=ja(),null!==c?(d=t(),null!==d?(h=ja(),null!==h?(e=Da(),null!==e?a=[a,c,d,h,e]:(a=null,b=f)):(a=null,b=f)):(a=null,b=f)):(a=null,b=f)):(a=null,b=f);return a}function Sc(){var a,c;c=b;"sip"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"SIP"'));null===a&&(a=t());null!==a&&(k.protocol=
a,a=void 0);null===a&&(b=c);return a}function Da(){var a,c;c=b;"udp"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"UDP"'));null===a&&("tcp"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"TCP"')),null===a&&("tls"===e.substr(b,3).toLowerCase()?(a=e.substr(b,3),b+=3):(a=null,0===f&&g('"TLS"')),null===a&&("sctp"===e.substr(b,4).toLowerCase()?(a=e.substr(b,4),b+=4):(a=null,0===f&&g('"SCTP"')),null===a&&(a=t()))));null!==a&&(k.transport=a,a=void 0);null===
a&&(b=c);return a}function Mc(){var a,c,d,e,f;e=b;a=Tc();null!==a?(f=b,c=xb(),null!==c?(d=Uc(),null!==d?c=[c,d]:(c=null,b=f)):(c=null,b=f),c=null!==c?c:"",null!==c?a=[a,c]:(a=null,b=e)):(a=null,b=e);return a}function Tc(){var a,c;c=b;a=Ta();null===a&&(a=N(),null===a&&(a=pa()));null!==a&&(k.host=e.substring(b,c),a=void 0);null===a&&(b=c);return a}function Uc(){var a,c,d,e,f,g,m;m=g=b;a=s();a=null!==a?a:"";null!==a?(c=s(),c=null!==c?c:"",null!==c?(d=s(),d=null!==d?d:"",null!==d?(e=s(),e=null!==e?e:
"",null!==e?(f=s(),f=null!==f?f:"",null!==f?a=[a,c,d,e,f]:(a=null,b=m)):(a=null,b=m)):(a=null,b=m)):(a=null,b=m)):(a=null,b=m);null!==a&&(k.port=parseInt(a.join("")),a=void 0);null===a&&(b=g);return a}function Xa(){var a,c,d,e,f;f=e=b;a=s();null!==a?(c=s(),c=null!==c?c:"",null!==c?(d=s(),d=null!==d?d:"",null!==d?a=[a,c,d]:(a=null,b=f)):(a=null,b=f)):(a=null,b=f);null!==a&&(a=parseInt(a.join("")));null===a&&(b=e);return a}function Vc(){var a,b;a=[];b=J();null===b&&(b=T(),null===b&&(b=A()));for(;null!==
b;)a.push(b),b=J(),null===b&&(b=T(),null===b&&(b=A()));return a}function Wc(){var a,c;c=b;"stuns"===e.substr(b,5).toLowerCase()?(a=e.substr(b,5),b+=5):(a=null,0===f&&g('"stuns"'));null===a&&("stun"===e.substr(b,4).toLowerCase()?(a=e.substr(b,4),b+=4):(a=null,0===f&&g('"stun"')));null!==a&&(k.scheme=a,a=void 0);null===a&&(b=c);return a}function jb(){var a,c,d,h,j;h=b;a=Xc();null!==a?(j=b,58===e.charCodeAt(b)?(c=":",b++):(c=null,0===f&&g('":"')),null!==c?(d=Sa(),null!==d?c=[c,d]:(c=null,b=j)):(c=null,
b=j),c=null!==c?c:"",null!==c?a=[a,c]:(a=null,b=h)):(a=null,b=h);return a}function Xc(){var a,c;c=b;a=N();null===a&&(a=pa(),null===a&&(a=ba()));null!==a&&(k.host=a,a=void 0);null===a&&(b=c);return a}function ba(){var a,c,d;d=b;a=[];c=kb();null===c&&(c=z(),null===c&&(c=lb()));for(;null!==c;)a.push(c),c=kb(),null===c&&(c=z(),null===c&&(c=lb()));null!==a&&(a=e.substring(b,d));null===a&&(b=d);return a}function kb(){var a;a=R();null===a&&(a=s(),null===a&&(45===e.charCodeAt(b)?(a="-",b++):(a=null,0===f&&
g('"-"')),null===a&&(46===e.charCodeAt(b)?(a=".",b++):(a=null,0===f&&g('"."')),null===a&&(95===e.charCodeAt(b)?(a="_",b++):(a=null,0===f&&g('"_"')),null===a&&(126===e.charCodeAt(b)?(a="~",b++):(a=null,0===f&&g('"~"')))))));return a}function lb(){var a;33===e.charCodeAt(b)?(a="!",b++):(a=null,0===f&&g('"!"'));null===a&&(36===e.charCodeAt(b)?(a="$",b++):(a=null,0===f&&g('"$"')),null===a&&(38===e.charCodeAt(b)?(a="&",b++):(a=null,0===f&&g('"&"')),null===a&&(39===e.charCodeAt(b)?(a="'",b++):(a=null,0===
f&&g('"\'"')),null===a&&(40===e.charCodeAt(b)?(a="(",b++):(a=null,0===f&&g('"("')),null===a&&(41===e.charCodeAt(b)?(a=")",b++):(a=null,0===f&&g('")"')),null===a&&(42===e.charCodeAt(b)?(a="*",b++):(a=null,0===f&&g('"*"')),null===a&&(43===e.charCodeAt(b)?(a="+",b++):(a=null,0===f&&g('"+"')),null===a&&(44===e.charCodeAt(b)?(a=",",b++):(a=null,0===f&&g('","')),null===a&&(59===e.charCodeAt(b)?(a=";",b++):(a=null,0===f&&g('";"')),null===a&&(61===e.charCodeAt(b)?(a="=",b++):(a=null,0===f&&g('"="'))))))))))));
return a}function Yc(){var a,c;c=b;"turns"===e.substr(b,5).toLowerCase()?(a=e.substr(b,5),b+=5):(a=null,0===f&&g('"turns"'));null===a&&("turn"===e.substr(b,4).toLowerCase()?(a=e.substr(b,4),b+=4):(a=null,0===f&&g('"turn"')));null!==a&&(k.scheme=a,a=void 0);null===a&&(b=c);return a}var Zc={CRLF:L,DIGIT:s,ALPHA:R,HEXDIG:H,WSP:S,OCTET:Ia,DQUOTE:F,SP:B,HTAB:I,alphanum:G,reserved:ha,unreserved:y,mark:rb,escaped:z,LWS:A,SWS:u,HCOLON:sb,TEXT_UTF8_TRIM:tb,TEXT_UTF8char:J,UTF8_NONASCII:M,UTF8_CONT:T,LHEX:function(){var a;
a=s();null===a&&(/^[a-f]/.test(e.charAt(b))?(a=e.charAt(b),b++):(a=null,0===f&&g("[a-f]")));return a},token:t,token_nodot:ia,separators:function(){var a;40===e.charCodeAt(b)?(a="(",b++):(a=null,0===f&&g('"("'));null===a&&(41===e.charCodeAt(b)?(a=")",b++):(a=null,0===f&&g('")"')),null===a&&(60===e.charCodeAt(b)?(a="<",b++):(a=null,0===f&&g('"<"')),null===a&&(62===e.charCodeAt(b)?(a=">",b++):(a=null,0===f&&g('">"')),null===a&&(64===e.charCodeAt(b)?(a="@",b++):(a=null,0===f&&g('"@"')),null===a&&(44===
e.charCodeAt(b)?(a=",",b++):(a=null,0===f&&g('","')),null===a&&(59===e.charCodeAt(b)?(a=";",b++):(a=null,0===f&&g('";"')),null===a&&(58===e.charCodeAt(b)?(a=":",b++):(a=null,0===f&&g('":"')),null===a&&(92===e.charCodeAt(b)?(a="\\",b++):(a=null,0===f&&g('"\\\\"')),null===a&&(a=F(),null===a&&(47===e.charCodeAt(b)?(a="/",b++):(a=null,0===f&&g('"/"')),null===a&&(91===e.charCodeAt(b)?(a="[",b++):(a=null,0===f&&g('"["')),null===a&&(93===e.charCodeAt(b)?(a="]",b++):(a=null,0===f&&g('"]"')),null===a&&(63===
e.charCodeAt(b)?(a="?",b++):(a=null,0===f&&g('"?"')),null===a&&(61===e.charCodeAt(b)?(a="=",b++):(a=null,0===f&&g('"="')),null===a&&(123===e.charCodeAt(b)?(a="{",b++):(a=null,0===f&&g('"{"')),null===a&&(125===e.charCodeAt(b)?(a="}",b++):(a=null,0===f&&g('"}"')),null===a&&(a=B(),null===a&&(a=I()))))))))))))))))));return a},word:Ja,STAR:ub,SLASH:ja,EQUAL:v,LPAREN:vb,RPAREN:wb,RAQUOT:Ka,LAQUOT:La,COMMA:w,SEMI:x,COLON:xb,LDQUOT:Ma,RDQUOT:Na,comment:Oa,ctext:Pa,quoted_string:U,quoted_string_clean:ka,qdtext:V,
quoted_pair:K,SIP_URI_noparams:la,SIP_URI:oa,uri_scheme:Qa,userinfo:ma,user:Ab,user_unreserved:Ra,password:Bb,hostport:na,host:W,hostname:Ta,domainlabel:Ua,toplabel:Cb,IPv6reference:pa,IPv6address:Va,h16:r,ls32:D,IPv4address:N,dec_octet:X,port:Sa,uri_parameters:yb,uri_parameter:Wa,transport_param:Db,user_param:Eb,method_param:Fb,ttl_param:Gb,maddr_param:Hb,lr_param:Ib,other_param:Jb,pname:Kb,pvalue:Lb,paramchar:Y,param_unreserved:Mb,headers:zb,header:ra,hname:Nb,hvalue:Ob,hnv_unreserved:Z,Request_Response:function(){var a;
a=hc();null===a&&(a=Pb());return a},Request_Line:Pb,Request_URI:Qb,absoluteURI:Za,hier_part:Sb,net_path:Ub,abs_path:sa,opaque_part:Tb,uric:$,uric_no_slash:Yb,path_segments:Xb,segment:ta,param:$a,pchar:aa,scheme:Rb,authority:Wb,srvr:Zb,reg_name:ba,query:Vb,SIP_Version:Ya,INVITEm:$b,ACKm:ac,OPTIONSm:bc,BYEm:cc,CANCELm:dc,REGISTERm:ec,SUBSCRIBEm:fc,NOTIFYm:gc,Method:qa,Status_Line:hc,Status_Code:ic,extension_code:kc,Reason_Phrase:jc,Allow_Events:function(){var a,c,d,e,f,g;f=b;a=ca();if(null!==a){c=[];
g=b;d=w();null!==d?(e=ca(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=ca(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},Call_ID:function(){var a,c,d,h,j,l;j=h=b;a=Ja();null!==a?(l=b,64===e.charCodeAt(b)?(c="@",b++):(c=null,0===f&&g('"@"')),null!==c?(d=Ja(),null!==d?c=[c,d]:(c=null,b=l)):(c=null,b=l),c=null!==c?c:"",null!==c?a=[a,c]:(a=null,b=j)):(a=null,b=j);null!==a&&(k=e.substring(b,h),a=void 0);
null===a&&(b=h);return a},Contact:function(){var a,c,d,e,f,g,m;f=b;a=ub();if(null===a)if(g=b,a=ua(),null!==a){c=[];m=b;d=w();null!==d?(e=ua(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);for(;null!==d;)c.push(d),m=b,d=w(),null!==d?(e=ua(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);null!==c?a=[a,c]:(a=null,b=g)}else a=null,b=g;if(null!==a){for(var q in k.multi_header)if(null===k.multi_header[q].parsed){k=null;break}k=null!==k?k.multi_header:-1;a=void 0}null===a&&(b=f);return a},contact_param:ua,name_addr:O,
display_name:va,contact_params:ab,c_p_q:lc,c_p_expires:mc,delta_seconds:P,qvalue:nc,generic_param:C,gen_value:oc,Content_Disposition:function(){var a,c,d,e,f,g;f=b;a=pc();if(null!==a){c=[];g=b;d=x();null!==d?(e=bb(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=x(),null!==d?(e=bb(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},disp_type:pc,disp_param:bb,handling_param:qc,Content_Encoding:function(){var a,c,d,e,f,g;
f=b;a=t();if(null!==a){c=[];g=b;d=w();null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},Content_Length:function(){var a,c,d;d=b;c=s();if(null!==c)for(a=[];null!==c;)a.push(c),c=s();else a=null;null!==a&&(k=parseInt(a.join("")),a=void 0);null===a&&(b=d);return a},Content_Type:function(){var a,c;c=b;a=rc();null!==a&&(k=e.substring(b,c),a=void 0);
null===a&&(b=c);return a},media_type:rc,m_type:sc,discrete_type:uc,composite_type:vc,extension_token:wa,x_token:wc,m_subtype:tc,m_parameter:cb,m_value:xc,CSeq:function(){var a,c,d,e;e=b;a=yc();null!==a?(c=A(),null!==c?(d=qa(),null!==d?a=[a,c,d]:(a=null,b=e)):(a=null,b=e)):(a=null,b=e);return a},CSeq_value:yc,Expires:function(){var a,c;c=b;a=P();null!==a&&(k=a,a=void 0);null===a&&(b=c);return a},Event:function(){var a,c,d,e,f,g,m;g=f=b;a=ca();if(null!==a){c=[];m=b;d=x();null!==d?(e=C(),null!==e?d=
[d,e]:(d=null,b=m)):(d=null,b=m);for(;null!==d;)c.push(d),m=b,d=x(),null!==d?(e=C(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);null!==c?a=[a,c]:(a=null,b=g)}else a=null,b=g;null!==a&&(k.event=a[0].join(""),a=void 0);null===a&&(b=f);return a},event_type:ca,From:function(){var a,c,d,e,f,g,m;g=f=b;a=la();null===a&&(a=O());if(null!==a){c=[];m=b;d=x();null!==d?(e=db(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);for(;null!==d;)c.push(d),m=b,d=x(),null!==d?(e=db(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,
b=m);null!==c?a=[a,c]:(a=null,b=g)}else a=null,b=g;if(null!==a){a=k.tag;try{k=new JsSIP.NameAddrHeader(k.uri,k.display_name,k.params),a&&k.setParam("tag",a)}catch(q){k=-1}a=void 0}null===a&&(b=f);return a},from_param:db,tag_param:eb,Max_Forwards:function(){var a,c,d;d=b;c=s();if(null!==c)for(a=[];null!==c;)a.push(c),c=s();else a=null;null!==a&&(k=parseInt(a.join("")),a=void 0);null===a&&(b=d);return a},Min_Expires:function(){var a,c;c=b;a=P();null!==a&&(k=a,a=void 0);null===a&&(b=c);return a},Name_Addr_Header:function(){var a,
c,d,e,f,g,m,q,p,r;p=q=b;a=[];for(c=va();null!==c;)a.push(c),c=va();if(null!==a)if(c=La(),null!==c)if(d=oa(),null!==d)if(e=Ka(),null!==e){f=[];r=b;g=x();null!==g?(m=C(),null!==m?g=[g,m]:(g=null,b=r)):(g=null,b=r);for(;null!==g;)f.push(g),r=b,g=x(),null!==g?(m=C(),null!==m?g=[g,m]:(g=null,b=r)):(g=null,b=r);null!==f?a=[a,c,d,e,f]:(a=null,b=p)}else a=null,b=p;else a=null,b=p;else a=null,b=p;else a=null,b=p;if(null!==a){try{k=new JsSIP.NameAddrHeader(k.uri,k.display_name,k.params)}catch(s){k=-1}a=void 0}null===
a&&(b=q);return a},Proxy_Authenticate:function(){return fb()},challenge:fb,other_challenge:zc,auth_param:da,digest_cln:xa,realm:Ac,realm_value:Hc,domain:Bc,URI:ya,nonce:Cc,nonce_value:Ic,opaque:Dc,stale:Ec,algorithm:Fc,qop_options:Gc,qop_value:za,Proxy_Require:function(){var a,c,d,e,f,g;f=b;a=t();if(null!==a){c=[];g=b;d=w();null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=
null,b=f)}else a=null,b=f;return a},Record_Route:function(){var a,c,d,e,f,g,m;g=f=b;a=Aa();if(null!==a){c=[];m=b;d=w();null!==d?(e=Aa(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);for(;null!==d;)c.push(d),m=b,d=w(),null!==d?(e=Aa(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);null!==c?a=[a,c]:(a=null,b=g)}else a=null,b=g;if(null!==a){for(var q in k.multi_header)if(null===k.multi_header[q].parsed){k=null;break}k=null!==k?k.multi_header:-1;a=void 0}null===a&&(b=f);return a},rec_route:Aa,Require:function(){var a,
c,d,e,f,g;f=b;a=t();if(null!==a){c=[];g=b;d=w();null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},Route:function(){var a,c,d,e,f,g;f=b;a=Ba();if(null!==a){c=[];g=b;d=w();null!==d?(e=Ba(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=Ba(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,
c]:(a=null,b=f)}else a=null,b=f;return a},route_param:Ba,Subscription_State:function(){var a,c,d,e,f,g;f=b;a=Jc();if(null!==a){c=[];g=b;d=x();null!==d?(e=gb(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=x(),null!==d?(e=gb(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},substate_value:Jc,subexp_params:gb,event_reason_value:Kc,Subject:function(){var a;a=tb();return null!==a?a:""},Supported:function(){var a,c,d,e,f,
g;f=b;a=t();if(null!==a){c=[];g=b;d=w();null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=t(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return null!==a?a:""},To:function(){var a,c,d,e,f,g,m;g=f=b;a=la();null===a&&(a=O());if(null!==a){c=[];m=b;d=x();null!==d?(e=hb(),null!==e?d=[d,e]:(d=null,b=m)):(d=null,b=m);for(;null!==d;)c.push(d),m=b,d=x(),null!==d?(e=hb(),null!==e?d=[d,e]:(d=null,b=m)):(d=
null,b=m);null!==c?a=[a,c]:(a=null,b=g)}else a=null,b=g;if(null!==a){a=k.tag;try{k=new JsSIP.NameAddrHeader(k.uri,k.display_name,k.params),a&&k.setParam("tag",a)}catch(q){k=-1}a=void 0}null===a&&(b=f);return a},to_param:hb,Via:function(){var a,c,d,e,f,g;f=b;a=Ca();if(null!==a){c=[];g=b;d=w();null!==d?(e=Ca(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);for(;null!==d;)c.push(d),g=b,d=w(),null!==d?(e=Ca(),null!==e?d=[d,e]:(d=null,b=g)):(d=null,b=g);null!==c?a=[a,c]:(a=null,b=f)}else a=null,b=f;return a},
via_parm:Ca,via_params:ib,via_ttl:Nc,via_maddr:Oc,via_received:Pc,via_branch:Qc,response_port:Rc,sent_protocol:Lc,protocol_name:Sc,transport:Da,sent_by:Mc,via_host:Tc,via_port:Uc,ttl:Xa,WWW_Authenticate:function(){return fb()},extension_header:function(){var a,c,d,e;e=b;a=t();null!==a?(c=sb(),null!==c?(d=Vc(),null!==d?a=[a,c,d]:(a=null,b=e)):(a=null,b=e)):(a=null,b=e);return a},header_value:Vc,message_body:function(){var a,b;a=[];for(b=Ia();null!==b;)a.push(b),b=Ia();return a},stun_URI:function(){var a,
c,d,h;h=b;a=Wc();null!==a?(58===e.charCodeAt(b)?(c=":",b++):(c=null,0===f&&g('":"')),null!==c?(d=jb(),null!==d?a=[a,c,d]:(a=null,b=h)):(a=null,b=h)):(a=null,b=h);return a},stun_scheme:Wc,stun_host_port:jb,stun_host:Xc,reg_name:ba,stun_unreserved:kb,sub_delims:lb,turn_URI:function(){var a,c,d,h,j,k,m;k=b;a=Yc();null!==a?(58===e.charCodeAt(b)?(c=":",b++):(c=null,0===f&&g('":"')),null!==c?(d=jb(),null!==d?(m=b,"?transport="===e.substr(b,11)?(h="?transport=",b+=11):(h=null,0===f&&g('"?transport="')),
null!==h?(j=Da(),null!==j?h=[h,j]:(h=null,b=m)):(h=null,b=m),h=null!==h?h:"",null!==h?a=[a,c,d,h]:(a=null,b=k)):(a=null,b=k)):(a=null,b=k)):(a=null,b=k);return a},turn_scheme:Yc,turn_transport:function(){var a,c,d,h,j;j=h=b;a=Da();if(null!==a){"udp"===e.substr(b,3).toLowerCase()?(c=e.substr(b,3),b+=3):(c=null,0===f&&g('"udp"'));if(null===c&&("tcp"===e.substr(b,3).toLowerCase()?(c=e.substr(b,3),b+=3):(c=null,0===f&&g('"tcp"')),null===c)){c=[];for(d=y();null!==d;)c.push(d),d=y()}null!==c?a=[a,c]:(a=
null,b=j)}else a=null,b=j;null!==a&&(k.transport=transport,a=void 0);null===a&&(b=h);return a}};if(void 0!==E){if(void 0===Zc[E])throw Error("Invalid rule name: "+pb(E)+".");}else E="CRLF";var b=0,f=0,Q=0,Ha=[],k={};if(null===Zc[E]()||b!==e.length){for(var mb=Math.max(b,Q),bd=mb<e.length?e.charAt(mb):null,nb=1,Ea=1,Fa=!1,ob=0;ob<Math.max(b,Q);ob++){var Ga=e.charAt(ob);"\n"===Ga?(Fa||nb++,Ea=1,Fa=!1):"\r"===Ga||"\u2028"===Ga||"\u2029"===Ga?(nb++,Ea=1,Fa=!0):(Ea++,Fa=!1)}qb=nb;ga=Ea;var cd=this.SyntaxError,
ea=Ha;ea.sort();for(var $c=null,ad=[],fa=0;fa<ea.length;fa++)ea[fa]!==$c&&(ad.push(ea[fa]),$c=ea[fa]);new cd(ad,bd,mb,qb,ga);return-1}return k},toSource:function(){return this._source},SyntaxError:function(e,E,L,ga,g){this.name="SyntaxError";this.expected=e;this.found=E;switch(e.length){case 0:e="end of input";break;case 1:e=e[0];break;default:e=e.slice(0,e.length-1).join(", ")+" or "+e[e.length-1]}E=E?pb(E):"end of input";this.message="Expected "+e+" but "+E+" found.";this.offset=L;this.line=ga;
this.column=g}};L.SyntaxError.prototype=Error.prototype;return L}();
